...
void DrawRegularTextBox(uint16_t *hl, uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint8_t e);
void DrawRegularTextBoxDMG(uint16_t *hl, uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint8_t e);
void ContinueDrawingTextBoxDMGorSGB(uint16_t *hl, uint8_t a, uint8_t b, uint8_t c, uint8_t d, uint8_t e);

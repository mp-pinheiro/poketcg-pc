...
static void adapt_Preload_Ronald1InPsychicClubLobby(ProbeState *s)
{
	Preload_Ronald1InPsychicClubLobbyResult r = Preload_Ronald1InPsychicClubLobby(s->b, s->c, s->d, s->e, s->hl);
...
const ProbeEntry probe_entries_psychic_club_lobby[] = {
	...
	{ "Preload_Ronald1InPsychicClubLobby", adapt_Preload_Ronald1InPsychicClubLobby },
	{ NULL, NULL },
};

...
static void adapt_OverworldMap_UpdatePlayerAndCursorSprites(ProbeState *s)
{
	(void)s;
...
static void adapt_OverworldMap_InitNextPlayerVelocity(ProbeState *s)
{
	OverworldMap_InitNextPlayerVelocity(s->b, s->c);
}
/* <<< factory OverworldMap_InitNextPlayerVelocity */

/* >>> factory OverworldMap_BeginPlayerMovement */
static void adapt_OverworldMap_BeginPlayerMovement(ProbeState *s)
{
	(void)s;
...
static void adapt_OverworldMap_UpdatePlayerWalkingAnimation(ProbeState *s)
{
	(void)s;
...
static void adapt_OverworldMap_HandleKeyPress(ProbeState *s)
{
	(void)s;
...
const ProbeEntry probe_entries_overworld_map[] = {
	...
	{ "OverworldMap_UpdatePlayerAndCursorSprites", adapt_OverworldMap_UpdatePlayerAndCursorSprites },

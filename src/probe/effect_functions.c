...
static void adapt_PoliwhirlDoubleslap_AIEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_JynxDoubleslap_AIEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_HydroPumpEffect(ProbeState *s)
{
	(void)s;
	HydroPumpEffect();
}
...
static void adapt_ItemFinder_HandDiscardPileCheck(ProbeState *s)
{
...
static void adapt_PrintArenaCardNameAndColorText(ProbeState *s)
{
...
static void adapt_PidgeottoMirrorMove_AfterDamage(ProbeState *s)
{
...
static void adapt_SpearowMirrorMove_AfterDamage(ProbeState *s)
{
...
static void adapt_SuperEnergyRemoval_DiscardEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_DamageSwap_SwapEffect(ProbeState *s)
{
...
static void adapt_PikachuLv16GrowlEffect(ProbeState *s)
{
	s->a = 0x12u;
...
static void adapt_SandAttackEffect(ProbeState *s)
{
	s->a = 0x02u;
...
static void adapt_HandleEnergyDiscardEffectSelection(ProbeState *s)
{
	(void)s;
...
static void adapt_GolduckHyperBeam_PlayerSelectEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_MirrorMove_PlayerSelection(ProbeState *s)
{
	(void)s;
...
static void adapt_Scavenge_PlayerSelectEnergyEffect(ProbeState *s)
{
...
static void adapt_ArcanineFlamethrower_PlayerSelectEffect(ProbeState *s)
{
...
static void adapt_Ember_PlayerSelectEffect(ProbeState *s)
{
...
static void adapt_FlareonFlamethrower_PlayerSelectEffect(ProbeState *s)
{
...
static void adapt_Conversion1_PlayerSelectEffect(ProbeState *s)
{
...
static void adapt_NidoranFCallForFamily_PutInPlayAreaEffect(ProbeState *s)
{
...
static void adapt_KrabbyCallForFamily_PutInPlayAreaEffect(ProbeState *s)
{
...
static void adapt_FireSpin_PlayerSelectEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_EnergySpike_AttachEnergyEffect(ProbeState *s)
{
...
static void adapt_PidgeyWhirlwind_SwitchEffect(ProbeState *s)
{
...
static void adapt_Gale_SwitchEffect(ProbeState *s)
{
...
static void adapt_ClefableMetronome_UseAttackEffect(ProbeState *s)
{
...
static void adapt_TossCoinATimes_BankB(ProbeState *s)
{
...
static void adapt_Serial_TossZeroCoins(ProbeState *s)
{
...
static void adapt_DancingEmbers_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_NidoranFFurySwipes_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_JolteonDoubleKick_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_PinMissile_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_PrimeapeFurySwipes_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_DragoniteLv45Slam_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_FuryAttack_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_NidorinaDoubleKick_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_NidorinoDoubleKick_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_OmastarSpikeCannon_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_JynxDoubleslap_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_PoliwhirlDoubleslap_MultiplierEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_PlayTrainerEffectAnimation(ProbeState *s)
{
...
static void adapt_HypnoDarkMind_DamageBenchEffect(ProbeState *s)
{
...
static void adapt_Spark_BenchDamageEffect(ProbeState *s)
{
...
static void adapt_ChainLightningEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_EnergyRetrieval_PlayerHandSelection(ProbeState *s)
{
	(void)s;
...
static void adapt_HandleEnergyCardsInDiscardPileSelection(ProbeState *s)
{
...
static void adapt_MewtwoAltEnergyAbsorption_PlayerSelectEffect(ProbeState *s)
{
	MewtwoAltEnergyAbsorption_PlayerSelectEffectResult result = MewtwoAltEnergyAbsorption_PlayerSelectEffect();
	s->a = result.a;
	s->f = result.f;
	s->hl = result.hl;
}
...
static void adapt_MewtwoEnergyAbsorption_PlayerSelectEffect(ProbeState *s)
{
	MewtwoEnergyAbsorption_PlayerSelectEffectResult result = MewtwoEnergyAbsorption_PlayerSelectEffect();
	s->a = result.a;
	s->f = result.f;
	s->hl = result.hl;
}
...
static void adapt_Maintenance_PlayerSelection(ProbeState *s)
{
	HandlePlayerSelection2HandCardsResult result = Maintenance_PlayerSelection();
	s->a = result.a;
	s->f = result.f;
}
/* <<< factory Maintenance_PlayerSelection */
...
static void adapt_ComputerSearch_PlayerDiscardHandSelection(ProbeState *s)
{
	HandlePlayerSelection2HandCardsResult result = ComputerSearch_PlayerDiscardHandSelection();
	s->a = result.a;
	s->f = result.f;
}
/* <<< factory ComputerSearch_PlayerDiscardHandSelection */
...
static void adapt_EarthquakeEffect(ProbeState *s)
{
	DealDamageToAllBenchedPokemonResult r = EarthquakeEffect(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
	s->a = r.a;
	s->f = r.f;
	s->b = r.b;
	s->c = r.c;
...
static void adapt_ComputerSearch_DiscardAddToHandEffect(ProbeState *s)
{
	ShuffleCardsInDeckResult r = ComputerSearch_DiscardAddToHandEffect(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
	s->a = r.a;
	s->f = r.f;
	s->b = r.b;
	s->c = r.c;
...
static void adapt_HealPlayAreaCardHP(ProbeState *s)
{
	HealPlayAreaCardHP(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
}
/* <<< factory HealPlayAreaCardHP */
...
static void adapt_SuperPotion_HealEffect(ProbeState *s)
{
	SuperPotion_HealEffect(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
}
/* <<< factory SuperPotion_HealEffect */
...
static void adapt_PidgeyWhirlwind_SelectEffect(ProbeState *s)
{
	PidgeyWhirlwindSelectEffectResult result = PidgeyWhirlwind_SelectEffect(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
	s->a = result.a;
	s->f = result.f;
}
/* <<< factory PidgeyWhirlwind_SelectEffect */
...
static void adapt_Teleport_PlayerSelectEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_TerrorStrike_50PercentSelectSwitchPokemon(ProbeState *s)
{
	TerrorStrike50PercentSelectSwitchPokemonResult result = TerrorStrike_50PercentSelectSwitchPokemon();
	s->a = result.a;
	s->f = result.f;
}
/* <<< factory TerrorStrike_50PercentSelectSwitchPokemon */
...
static void adapt_DevolutionSpray_DevolutionEffect(ProbeState *s)
{
	(void)s;
...
static void adapt_Curse_TransferDamageEffect(ProbeState *s)
{
	(void)s;

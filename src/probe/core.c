...
{
	PlayDeckShuffleAnimationResult r = PlayDeckShuffleAnimation(s->c, s->e);
	s->a = r.a;
	s->c = r.c;
	s->e = r.e;
}
...
static void adapt_DisplayCardPage_PokemonAttack1Page2(ProbeState *s)
{
	DisplayCardPage_PokemonAttack1Page2(s->b, s->c, s->d);
}
/* <<< factory DisplayCardPage_PokemonAttack1Page2 */

/* >>> factory DisplayCardPage_PokemonAttack2Page1 */
static void adapt_DisplayCardPage_PokemonAttack2Page1(ProbeState *s)
{
	DisplayCardPage_PokemonAttack2Page1(s->b, s->c, s->d);
}
/* <<< factory DisplayCardPage_PokemonAttack2Page1 */

/* >>> factory DisplayAttackPage_Attack1Page1 */
static void adapt_DisplayAttackPage_Attack1Page1(ProbeState *s)
{
	DisplayAttackPage_Attack1Page1(s->b, s->c, s->d);
}
/* <<< factory DisplayAttackPage_Attack1Page1 */

/* >>> factory DisplayAttackPage_Attack2Page1 */
static void adapt_DisplayAttackPage_Attack2Page1(ProbeState *s)
{
	DisplayAttackPage_Attack2Page1(s->b, s->c, s->d);
}
/* <<< factory DisplayAttackPage_Attack2Page1 */
...
static void adapt_DisplayAttackPage_Attack1Page2(ProbeState *s)
{
	DisplayAttackPage_Attack1Page2(s->b, s->c, s->d);
}
/* <<< factory DisplayAttackPage_Attack1Page2 */
...
static void adapt_DisplayEnergyDiscardScreen(ProbeState *s)
{
	DisplayEnergyDiscardScreen(s->a);
}
/* <<< factory DisplayEnergyDiscardScreen */

/* >>> factory OpenAttackPage */
static void adapt_OpenAttackPage(ProbeState *s)
{
	(void)s;
	OpenAttackPage();
}
...
static void adapt_PracticeDuel_RepeatInstructions(ProbeState *s)
{
	s->f = PracticeDuel_RepeatInstructions();
}
/* <<< factory PracticeDuel_RepeatInstructions */
...
static void adapt_OpenCardPage(ProbeState *s)
{
	OpenCardPage(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
}
/* <<< factory OpenCardPage */
...
{
	WaitResult r = DisplayCardDetailScreen(s->a, s->hl);
	s->f = r.f;
}
/* <<< factory DisplayCardDetailScreen */

/* >>> factory OpenCardPage_FromHand */
static void adapt_OpenCardPage_FromHand(ProbeState *s)
{
	OpenCardPage_FromHand(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
}
/* <<< factory OpenCardPage_FromHand */
...
static void adapt_OpenCardPage_FromCheckHandOrDiscardPile(ProbeState *s)
{
	OpenCardPage_FromCheckHandOrDiscardPile(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
}
/* <<< factory OpenCardPage_FromCheckHandOrDiscardPile */
...
static void adapt_DisplayCardPage_Energy(ProbeState *s)
{
	PrintAttackOrCardDescriptionResult r = DisplayCardPage_Energy(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
	s->a = r.a; s->d = r.d; s->e = r.e; s->f = r.f; s->hl = r.hl;
}
/* <<< factory DisplayCardPage_Energy */

/* >>> factory DisplayCardPage_TrainerPage2 */
static void adapt_DisplayCardPage_TrainerPage2(ProbeState *s)
{
	PrintAttackOrCardDescriptionResult r = DisplayCardPage_TrainerPage2(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
	s->a = r.a; s->d = r.d; s->e = r.e; s->f = r.f; s->hl = r.hl;
}
/* <<< factory DisplayCardPage_TrainerPage2 */
...
static void adapt_PracticeDuel_PrintTurnInstructions(ProbeState *s)
{
	(void)s;
...
static void adapt_AttemptRetreat(ProbeState *s)
{
	AttemptRetreatResult result = AttemptRetreat();
	s->a = result.a;
	s->f = result.f;
}
/* <<< factory AttemptRetreat */
...
static void adapt_OppAction_AttemptRetreat(ProbeState *s)
{
	WaitResult result = OppAction_AttemptRetreat();
	s->f = result.f;
}
/* <<< factory OppAction_AttemptRetreat */
...
static void adapt_OpenTurnHolderHandScreen_Simple(ProbeState *s)
{
	s->f = OpenTurnHolderHandScreen_Simple();
}
/* <<< factory OpenTurnHolderHandScreen_Simple */
...
static void adapt_OpenNonTurnHolderDiscardPileScreen(ProbeState *s)
{
	OpenDiscardPileScreenResult result = OpenNonTurnHolderDiscardPileScreen(s->c);
	s->f = result.f;
}
/* <<< factory OpenNonTurnHolderDiscardPileScreen */
...
static void adapt_CheckDamageToMrMime(ProbeState *s)
{
	CheckDamageToMrMimeResult r = CheckDamageToMrMime(s->a, s->f, s->b, s->c, s->d, s->e, s->hl);
	s->a = r.a;
	s->f = r.f;
}
/* <<< factory CheckDamageToMrMime */
...
static void adapt_PlayShuffleAndDrawCardsAnimation(ProbeState *s)
{
	PlayShuffleAndDrawCardsAnimation(s->b, s->c, s->d, s->e, s->hl);
}
/* <<< factory PlayShuffleAndDrawCardsAnimation */
...
static void adapt_OppAction_ExecuteTrainerCardEffectCommands(ProbeState *s)
{
	OppAction_ExecuteTrainerCardEffectCommands(s->b, s->d, s->e);
}
/* <<< factory OppAction_ExecuteTrainerCardEffectCommands */
...
static void adapt_TurnDuelistTakePrizes(ProbeState *s)
{
	TurnDuelistTakePrizesResult r = TurnDuelistTakePrizes();
	s->a = r.a;
	s->f = r.f;
	s->hl = r.hl;
}
...
static void adapt_OppAction_ForceSwitchActive(ProbeState *s)
{
	(void)s;
...
static void adapt__ContinueDuel(ProbeState *s)
{
	(void)s;
	_ContinueDuel();
}
...
static void adapt_TryContinueDuel(ProbeState *s)
{
	(void)s;
	TryContinueDuel();
}
...
const ProbeEntry probe_entries_core[] = {
	...
	{ "DisplayCardPage_PokemonAttack1Page2", adapt_DisplayCardPage_PokemonAttack1Page2 },

...
CASES={"_HandleMapWarp":[dict(POISON,wram=_memory(1,0x1A,0x0A,2,b"\0\0\0\0")),{"wram":_memory(1,0,0,0)},{"wram":_memory(1,0x0E,0x1C,1)},{"wram":_memory(1,0x10,0x1C,3)},{"wram":_memory(2,0,0x0A,4)}]}

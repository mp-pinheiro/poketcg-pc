...
MUTATIONS["PlayerNamingScreen_CheckButtonState"] = {"source_symbol": "PlayerNamingScreen_CheckButtonState", "before": "\t\tuint8_t tile = gb_read8((uint8_t)(old_blink + 1u) & (1u << B_CURSOR_BLINK_PERIOD_800)\n\t\t                        ? wInvisibleCursorTile_ADDR : wVisibleCursorTile_ADDR);", "after": "\t\tuint8_t tile = gb_read8((uint8_t)(old_blink + 1u) & (1u << B_CURSOR_BLINK_PERIOD_800)\n\t\t                        ? wVisibleCursorTile_ADDR : wInvisibleCursorTile_ADDR);", "case_ids": ["PlayerNamingScreen_CheckButtonState-0"]}
# <<< factory-mutation PlayerNamingScreen_CheckButtonState

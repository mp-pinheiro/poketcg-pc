...
CONTRACT = {
    ...
    "CopyDeckData": ("a", "b", "c", "d", "e", "f", "hl"),
    "CountPrizes": ("a", "b", "c", "d", "e", "hl"),
    "ShuffleDeck": ("a", "b", "c", "d", "e", "f", "hl"),
    "DrawCardFromDeck": ("a", "f"),
    "ReturnCardToDeck": ("a", "b", "c", "d", "e", "f", "hl"),
    "SearchCardInDeckAndAddToHand": ("a", "b", "c", "d", "e", "f", "hl"),
    "AddCardToHand": ("a", "b", "c", "d", "e", "f", "hl"),
    "RemoveCardFromHand": ("a", "b", "c", "d", "e", "f", "hl"),
    "MoveHandCardToDiscardPile": ("a", "f", "hl"),
    "PutCardInDiscardPile": ("a", "b", "c", "d", "e", "f", "hl"),
    "MoveDiscardPileCardToHand": ("a", "f"),
    "CheckPrizeTaken": ("a", "b", "c", "d", "e", "f", "hl"),
    "SortCardsInListByID_CheckForListTerminator": ("a", "b", "c", "d", "e", "f", "hl"),
    "CheckIfCanEvolveInto": ("a", "b", "c", "d", "e", "f", "hl"),
    "CheckIfCanEvolveInto_BasicToStage2": ("a", "f", "hl"),
    "EvolvePokemonCardIfPossible": ("a", "c", "d", "e", "f", "hl"),
    "EvolvePokemonCard": ("a", "c", "e", "f", "hl"),
    "ClearAllStatusConditions": ("b", "c", "d", "e", "hl"),
    "PutHandCardInPlayArea": ("a", "b", "c", "d", "e", "hl"),
    "PutHandPokemonCardInPlayArea": ("a", "b", "c", "d", "f", "hl"),
    "EmptyPlayAreaSlot": ("a", "b", "c", "d", "e", "f", "hl"),
    "MovePlayAreaCardToDiscardPile": ("a", "b", "c", "d", "e", "f", "hl"),
    "SwapPlayAreaPokemon": ("a", "b", "c", "d", "e", "f", "hl"),
    "SwapArenaWithBenchPokemon": ("a", "b", "c", "d", "e", "f", "hl"),
    "ShiftTurnPokemonToFirstPlayAreaSlots": ("a", "b", "c", "d", "e", "f", "hl"),
    "ShiftAllPokemonToFirstPlayAreaSlots": ("a", "b", "c", "d", "e", "f", "hl"),
    "GetPlayAreaCardAttachedEnergies": ("a", "b", "c", "d", "e", "f", "hl"),
    "CopyAttackDataAndDamage": ("a", "b", "c", "d", "e", "f", "hl"),
    "CopyAttackDataAndDamage_FromDeckIndex": ("a", "b", "c", "d", "e", "f", "hl"),
    "CopyAttackDataAndDamage_FromCardID": ("a", "b", "c", "d", "e", "f", "hl"),
    "ReturnCarry": ("a", "b", "c", "d", "e", "f", "hl"),
    "LoadNonPokemonCardEffectCommands": ("a", "b", "c", "d", "e", "hl"),
    "ApplyAttachedPlusPower": ("b", "c", "d", "e", "hl"),
    "ApplyAttachedDefender": ("b", "c", "d", "e", "hl"),
    "MoveCardToDiscardPileIfInPlayArea": ("a", "b", "c", "f", "hl"),

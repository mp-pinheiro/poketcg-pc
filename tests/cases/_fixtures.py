...
def attack_fixture(**changes: bytes) -> dict:
    ...
    return {"wram": spans, "entry_sp": _ATTACK["sp"],
            "read": {0xC200: 0x200, 0xCC00: 0x100}, "vread": {0: {0x9800: 0x400}},

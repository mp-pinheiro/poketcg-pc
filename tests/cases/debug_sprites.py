...
MUTATIONS = {
    ...
    "Func_1c866": {
        ...
        "case_ids": ["Func_1c866-2", "Func_1c866-3"],
    },
    "Func_1c890": {
        "source_symbol": "Func_1c890",
        "before": "a = (uint8_t)(UpdateRNGSources() & (1u << SPRITE_ANIM_FLAG_CENTERED_F));",
        "after": "a = (uint8_t)(UpdateRNGSources() & (1u << (SPRITE_ANIM_FLAG_CENTERED_F - 1u)));",

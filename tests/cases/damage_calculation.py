...
MUTATIONS = {
    "CalculateDamage_VersusDefendingPokemon": {"source_symbol": "CalculateDamage_VersusDefendingPokemon", "before": "((status & (DOUBLE_POISONED & (POISONED ^ 0xFFu))) ? 20u : 10u)", "after": "((status & (DOUBLE_POISONED & (POISONED ^ 0xFFu))) ? 10u : 20u)", "case_ids": ["CalculateDamage_VersusDefendingPokemon-4", "CalculateDamage_VersusDefendingPokemon-1"]},
    "CalculateDamage_FromDefendingPokemon": {

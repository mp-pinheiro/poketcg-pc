...
CASES["HandleAIPkmnPowers"] = [
    # water-master 419138: Amy's turn, the live entry the sweep flagged (a, f).
    dict(ai_pkmn_powers_master_fixture(vram=False, bank=8), **AI_PKMN_POWERS_MASTER_REGS, read={0xCE08: 1, 0xFF9D: 1}),

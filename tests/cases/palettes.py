...
CASES = {
    "FlushPalettesIfRequested": [
        ...
        {"wram": {WFLAG: b"\x80", WBGP: b"\x11", WOBP0: b"\x22", WOBP1: b"\x33"},
         "oracle": False, "why": WHY_IO,
         "expect": {RBGP: b"\x11", ROBP0: b"\x22", ROBP1: b"\x33"}},
        {"wram": {WFLAG: b"\x00", RBGP: b"\xAA", ROBP0: b"\xBB", ROBP1: b"\xCC"},
         "oracle": False,
         "why": "flags=0 takes the ret z path before any palette write, so the "
                "I/O registers must be left exactly as seeded",
         "expect": {RBGP: b"\xAA", ROBP0: b"\xBB", ROBP1: b"\xCC"}},
    ],
    "FlushPalettes": [
        ...
        {"a": 0x80, "wram": {WLCDC: b"\x00", WBGP: b"\x44", WOBP0: b"\x55", WOBP1: b"\x66"},
         "oracle": False, "why": WHY_IO,
         "expect": {RBGP: b"\x44", ROBP0: b"\x55", ROBP1: b"\x66"}},
    ],
    "FlushPalette0": [
        ...
        {"wram": {WLCDC: b"\x00", WBGP: b"\x12", WOBP0: b"\x34", WOBP1: b"\x56"},
         "oracle": False, "why": WHY_IO,
         "expect": {RBGP: b"\x12", ROBP0: b"\x34", ROBP1: b"\x56"}},
    ],
    "FlushAllPalettes": [
        {"wram": {WLCDC: b"\x00"}, "read": {WFLAG: 1}},
        ...
        {"wram": {WLCDC: b"\x00", WBGP: b"\x01", WOBP0: b"\x02", WOBP1: b"\x03"},
         "oracle": False, "why": WHY_IO,
         "expect": {RBGP: b"\x01", ROBP0: b"\x02", ROBP1: b"\x03"}},
    ],
    "FlushPalette": [
        ...
        {"a": 0x03, "wram": {WLCDC: b"\x00", WBGP: b"\xA1", WOBP0: b"\xB2", WOBP1: b"\xC3"},
         "oracle": False, "why": WHY_IO,
         "expect": {RBGP: b"\xA1", ROBP0: b"\xB2", ROBP1: b"\xC3"}},
    ],
    "SetBGP": [
        ...
        {"a": 0x1B, "wram": {WLCDC: b"\x00", WOBP0: b"\x99", WOBP1: b"\x88"},
         "oracle": False, "why": WHY_IO,
         "expect": {RBGP: b"\x1b", ROBP0: b"\x99", ROBP1: b"\x88"}},
    ],
    "SetOBP0": [
        ...
        {"a": 0x7E, "wram": {WLCDC: b"\x00", WBGP: b"\x77", WOBP1: b"\x66"},
         "oracle": False, "why": WHY_IO,
         "expect": {ROBP0: b"\x7e", RBGP: b"\x77", ROBP1: b"\x66"}},
    ],
    "SetOBP1": [
        ...
        {"a": 0x5A, "wram": {WLCDC: b"\x00", WBGP: b"\x11", WOBP0: b"\x22"},
         "oracle": False, "why": WHY_IO,
         "expect": {ROBP1: b"\x5a", RBGP: b"\x11", ROBP0: b"\x22"}},
    ],
}

...
ROUTINES: dict[str, tuple[str, ...]] = {
    ...
    "tiles": ("FillRectangle", "Copy1bppTiles", "CopyFontsOrDuelGraphicsTiles",
              ...
              "LoadFullWidthFontTiles", "Func_2057"),
    ...
    "sram": ("BankswitchSRAM", "EnableSRAM", "DisableSRAM"),
    ...
    "map": ("GetPermissionByteOfMapPosition", "GetPermissionOfMapPosition",
            ...
            "GetDefaultSong", "PlayDefaultSong", "_ExecuteGameEvent"),
    "load_deck": ("LoadDeck",),
"card_color": ("GetCardWeakness", "GetArenaCardWeakness", "GetPlayAreaCardWeakness",
    ...
    "serial": ("SerialTimerHandler", "Func_0cc5", "SerialHandler",
               ...
               "UnreferencedGoToSerialReturnAddress", "DuelTransmissionError"),
    "printer": ("SendNextPrinterPacketByte", "SendByteThroughSerialData",
                "ExecutePrinterPacketSequence", "PrinterMenu_QuitPrint"),
    ...
    "load_gfx": ("LoadTilemap_ToSRAM", "LoadTilemap_ToVRAM", "LoadTilemap",
                 ...
                 "LoadOBPalette", "LoadPaletteDataToBuffer", "Func_80238"),
    ...
    "mail": ("GePCPackSelectionCoordinates", "TryGivePCPack"),
    ...
    "copy_card_name": ("_CopyCardNameAndLevel_HalfwidthText",),
    "credits_sequence_commands": ("SetCreditsSequenceCmdPtr",
    ...
    "gift_center": ("Func_fcad", "Preload_GiftCenterClerk"),
    "warp": ("_HandleMapWarp",),
    "mason_laboratory": ("Script_Tech1", "Preload_DrMason"),
}
